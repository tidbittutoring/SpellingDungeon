...
const ItemData = {
    ...
    SlotStats: {
        HEAD: ["hp", "ink", "hp_regen", "ink_regen", "armor", "first_letter_chance", "last_letter_chance", "double_letter_chance", "random_letter_chance", "time_warp", "item_find", "glow", "cascade"],
        TORSO: ["hp", "ink", "hp_regen", "ink_regen", "armor", "item_find", "cascade"],
        MAIN_HAND: ["ink", "ink_regen", "lockpick", "item_find", "glow", "cascade"],
        OFF_HAND: ["hp", "hp_regen", "armor", "ink", "ink_regen", "first_letter_chance", "last_letter_chance", "double_letter_chance", "random_letter_chance", "time_warp", "item_find", "glow", "cascade"],
        ACCESSORY: ["hp_regen", "ink_regen", "first_letter_chance", "last_letter_chance", "double_letter_chance", "random_letter_chance", "time_warp", "item_find", "glow", "cascade"]
    },
